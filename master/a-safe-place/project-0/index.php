<?php header('Content-type: text/html; charset=utf-8');
	...
	$functions_excluded = array('#^gz([a-z]++)#', '#^zlib\_#', '#^array\_#', '#^ldap\_#', '#^mysqli\_#', '__halt_compiler', 'array', 'key', 'echo', 'empty', 'eval', 'exit', 'isset', 'list', 'print', 'unset'); // You can use regular expression with delimiters (only # for delimiters)
